...
public abstract class Listas {
    ...
    public static void telaLista(listaDeDesejos lista){
        ...
        System.out.println("            " + lista.getDataCriacao());
    ...
    public static void telaUsuarios(List<usuario> usuarios){
        ...
        for (usuario u : usuarios) {
            System.out.println("|ID: " +  u.getId() + " |" + "Tipo: " + u.getTipo() + " |" + "Data de nascimento: " + u.getDataNasc() + " |" + "Email: " + u.getE_mail() + " |" + "Telefone: " + u.getTelefone() + " |" + "Telefone: " + u.getTelefone() + " |" + "Endereço: " + u.getEndereco()+ " |");
        }
    }
